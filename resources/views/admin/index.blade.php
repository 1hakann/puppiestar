                            ...
                            <tbody>
                                <tr>
                                    <td class="border-top-0 px-2 py-4">
                                        <div class="d-flex no-block align-items-center">
                                            <div class="mr-3"><img
                                                    src="{{asset('admins/assets/images/users/widget-table-pic1.jpg')}}"
                                ...
                                <tr>
                                    <td class="px-2 py-4">
                                        <div class="d-flex no-block align-items-center">
                                            <div class="mr-3"><img
                                                    src="{{asset('admins/assets/images/users/widget-table-pic2.jpg')}}"
                                                    alt="user" class="rounded-circle" width="45"
                                                    height="45" /></div>
                                            <div class="">
                                ...
                                <tr>
                                    <td class="px-2 py-4">
                                        <div class="d-flex no-block align-items-center">
                                            <div class="mr-3"><img
                                                    src="{{asset('admins/assets/images/users/widget-table-pic3.jpg')}}"
                                                    alt="user" class="rounded-circle" width="45"
                                                    height="45" /></div>
                                            <div class="">
                                ...
                                <tr>
                                    <td class="px-2 py-4">
                                        <div class="d-flex no-block align-items-center">
                                            <div class="mr-3"><img
                                                    src="{{asset('admins/assets/images/users/widget-table-pic4.jpg')}}"
                                                    alt="user" class="rounded-circle" width="45"
                                                    height="45" /></div>
                                            <div class="">
...
<!--This Pages Scripts -->
<script src="{{asset('admins/js/d3.min.js')}}"></script>
<script src="{{asset('admins/js/c3.min.js')}}"></script>
<script src="{{asset('admins/js/chartist.min.js')}}"></script>
<script src="{{asset('admins/js/chartist-plugin-tooltip.min.js')}}"></script>
<script src="{{asset('admins/js/jquery-jvectormap-2.0.2.min.js')}}"></script>
<script src="{{asset('admins/js/jquery-jvectormap-world-mill-en.js')}}"></script>
<script src="{{asset('admins/js/dashboard1.min.js')}}"></script>
@endsection