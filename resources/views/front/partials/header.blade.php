            ...
            <div class="ht-right">
                ...
                <div class="lan-selector">
                    <select class="language_drop" name="countries" id="countries" style="width:300px;">
                        ...
                        <option value='yu' data-image="{{asset('puppiestar/img/flag-2.jpg')}}" data-imagecss="flag yu"
        ...
        <div class="inner-header">
            <div class="row">
                <div class="col-lg-2 col-md-2">
                    <div class="logo">
                        <a href="./index.html">
                            <img src="{{asset('puppiestar/img/logo.png')}}" alt="">
                        </a>
                    </div>
                </div>
                            ...
                            <div class="cart-hover">
                                <div class="select-items">
                                    <table>
                                        <tbody>
                                            <tr>
                                                <td class="si-pic"><img src="{{asset('puppiestar/img/select-product-1.jpg')}}" alt=""></td>
                                                <td class="si-text">
                                            ...
                                            <tr>
                                                <td class="si-pic"><img src="{{asset('puppiestar/img/select-product-2.jpg')}}" alt=""></td>
                                                <td class="si-text">
                                                    <div class="product-selected">
                                                        <p>$60.00 x 1</p>
                                                        <h6>Kabino Bedside Table</h6>
